...
exports.Rearkdown = function (_a) {
    ...
    return (React.createElement("div", null, state && (React.createElement(markdown_to_jsx_1.default, { children: state, options: __assign({ overrides: overridesObject }, options) }))));
};
